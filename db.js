...
// proposée. Accepter la fait rejoindre assignedTo ; refuser la retire juste
// de proposedTo (la tâche redevient normalement gérable si elle n'a plus de
// fixedAssignment, cf. logique du formulaire admin).
...
export async function declineTaskProposal(id, password) {
  ...
  await runTransaction(firestore, async (tx) => {
    ...
    tx.update(ref, { proposedTo: proposed });
  });
}
