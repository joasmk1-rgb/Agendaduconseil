...
const columnEls = { bulk: bulkMarkSection, grid: gridScrollEl, tasks: tasksSection };
const columnToggleBtns = { bulk: toggleColBulkBtn, grid: toggleColGridBtn, tasks: toggleColTasksBtn };
let visibleColumns = { bulk: true, grid: true, tasks: true };
try {
