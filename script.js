...
// La barre d'onglets entière (pas juste les boutons ODJ/Tâches) ne sert à
// rien tant que l'admin n'a activé aucun des deux onglets optionnels — dans
// ce cas, un seul bouton "Calendrier" cliquable n'apporterait rien.
function applyPublicTabsVisibility() {
  ...
  publicTabs.classList.toggle("hidden", !agendaEnabled && !tasksEnabled);
